...
pub struct ActiveStatus {
    ...
    pub firmware_slot_idx: usize,
    pub total_firmware_segments: u32,
    pub remaining_firmware_segments: u32,

    pub parity_slot_idx: usize,
    pub total_parity_segments: u32,
    pub remaining_parity_segments: u32,
}
